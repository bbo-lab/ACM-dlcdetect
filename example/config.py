...
date = '20210511'
task = 'table_4'
folderPath_ccv = f'/media/smb/bbo3102/data/bulk/pose_B.EG.1.09/experiments/{date}_{task}/' # folder in which the ccv-files need to be placed
filePath_labels = f'/home/voit/Dropbox (NIG)/public_share/ACM/datasets_figures/required_files/{date}/{task}/labels.npz'
